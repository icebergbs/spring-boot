...
docker pull registry.cn-hangzhou.aliyuncs.com/mixlink/platform-web:${ipaas_version}
...
--restart=always \
-d registry.cn-hangzhou.aliyuncs.com/mixlink/platform-web:${ipaas_version}
