...
docker pull registry.cn-hangzhou.aliyuncs.com/mixlink/zeebe-monitor:${ipaas_version}
docker logout
...
-e PARAMS="${params}" \
--restart=always \
-d registry.cn-hangzhou.aliyuncs.com/mixlink/zeebe-monitor:${ipaas_version}
